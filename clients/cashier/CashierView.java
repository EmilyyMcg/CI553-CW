...
public class CashierView implements Observer
{
  ...
  private final JButton     theBtdoUndo= new JButton( UNDO );
  ...
  public CashierView(  RootPaneContainer rpc,  MiddleFactory mf, int x, int y  )
  {
    ...
    theBtdoUndo.setBounds( 16, 25+60*2, 80, 40 );   // Clear Button
    theBtdoUndo.addActionListener(                  // Call back code
            e -> cont.doUndo());
    theOutput.setText("");;
    theBtdoUndo.setBackground(Color.black);
    theBtdoUndo.setForeground(Color.white);
    cp.add( theBtdoUndo );
  }
